...
public class PedidosSpringApplication implements CommandLineRunner {
	/*
	 * Eliminado para testing automatico
	 * 
	 * @Autowired
	 ...
	 * Eliminado para testing automatico
	 * 
	 * // Mantienen referencias al Almacen "principal" y al Cliente "Pepe", creados
	 * en "crearEntidades()", para ser usadas en "consultarEntidades()"
	 ...
	 * Articulo a3 = new Articulo("tuerca acero", "tuerca de acero 10/18", f2,
	 * 10.0);
	 ...
	 * 
	 * Direccion d1 = new Direccion("calle 1", "Ourense", "11111", "Ourense",
	 * "988111111");
	 * Direccion d2 = new Direccion("calle 2", "Santiago", "22222", "A Coruña",
	 * "981222222");
	 * 
	 ...
	 * 
	 * Direccion d3 = new Direccion("calle 3", "Santiago", "33333", "A Coruña",
	 * "981333333");
	 ...
	 * );
	 * List<ArticuloAlmacen> stocks =
	 * articuloAlmacenDAO.findByArticuloId(almacenPrincipal.getId());
